      ...
      >
        <div className="flex items-center justify-between gap-2 px-2">
          <div className="flex items-center gap-2 min-w-0">
            <div className="h-10 w-10 rounded-xl bg-gradient-to-br from-cyan-400 to-fuchsia-500 flex items-center justify-center shadow-[0_0_24px_rgba(34,211,238,0.4)]">
              <Radar className="w-6 h-6 text-void" />
            </div>
            <div>
              <p className="text-xs uppercase tracking-widest text-cyan-600 dark:text-cyan-400/80">AquaSense</p>
              <p className="text-sm font-semibold text-slate-900 dark:text-white leading-tight">Leak AI</p>
            </div>
          </div>
